...
import { ToggleUserInfoDialogAction } from './dialogs/user-info';
...
import { LoadUsersAction, LoggedInUserAction } from './user';
...
export enum ActionTypes {
  ...
  TOGGLE_USER_INFO_DIALOG = 'TOGGLE_USER_INFO_DIALOG',
}
